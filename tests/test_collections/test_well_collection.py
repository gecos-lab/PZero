...
class TestWellConnection:
    ...
    def test_add_entity_from_dict(self):
        ...
        assert (
            self.well_istance.get_number_of_entities() == 1
    ...
    def test_remove_entity(self):
        ...
        assert (
            self.well_istance.get_number_of_entities() == 0
    ...
    def test_replace_vtk(self):
        ...
        self.well_istance.replace_vtk(
            uid=self.well_entity_dict_1["uid"], vtk_object=self.vtk_obj2
        )
        ...
        assert (
            self.well_istance.get_number_of_entities() == 1
            and self.well_istance.get_uid_vtk_obj(self.well_entity_dict_1["uid"])
            == self.vtk_obj2
        )
