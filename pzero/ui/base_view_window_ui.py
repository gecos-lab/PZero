...
################################################################################
## Form generated from reading UI file 'base_view_windowbwJJjR.ui'
##
...
class Ui_BaseViewWindow(object):
    def setupUi(self, BaseViewWindow):
        ...
        self.GeologyTreePage.setGeometry(QRect(0, 0, 241, 168))
        ...
        self.GeologyTopologyTreePage.setGeometry(QRect(0, 0, 241, 168))
