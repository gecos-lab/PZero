...
################################################################################
## Form generated from reading UI file 'import_windowDTcbXj.ui'
##
...
class Ui_ImportOptionsWindow(object):
    def setupUi(self, ImportOptionsWindow):
        ...
        self.AssignTable.horizontalHeader().setProperty("showSortIndicator", True)
        ...
        sizePolicy3.setHeightForWidth(
            self.PathlineEdit.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, ImportOptionsWindow):
        ImportOptionsWindow.setWindowTitle(
            QCoreApplication.translate("ImportOptionsWindow", "Import options", None)
        )
        self.actionImport.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Import", None)
        )
        self.dataPreviewLabel.setText(
            QCoreApplication.translate(
                "ImportOptionsWindow", "Preview data table", None
            )
        )
        self.dataAssignLabel.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Assign data table", None)
        )
        self.OptionsLabel.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Import options", None)
        )
        self.PathlineEdit.setPlaceholderText(
            QCoreApplication.translate("ImportOptionsWindow", "file path...", None)
        )
        self.PathtoolButton.setText(
            QCoreApplication.translate("ImportOptionsWindow", "...", None)
        )
        self.StartOnLabel.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Start from line", None)
        )
        self.EndOnLabel.setText(
            QCoreApplication.translate("ImportOptionsWindow", "End on line", None)
        )
        self.SeparatoLabel.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Separator", None)
        )
        self.SeparatorcomboBox.setItemText(
            0, QCoreApplication.translate("ImportOptionsWindow", "<space>", None)
        )
        self.SeparatorcomboBox.setItemText(
            1, QCoreApplication.translate("ImportOptionsWindow", "<comma>", None)
        )
        self.SeparatorcomboBox.setItemText(
            2, QCoreApplication.translate("ImportOptionsWindow", "<semi-col>", None)
        )
        self.SeparatorcomboBox.setItemText(
            3, QCoreApplication.translate("ImportOptionsWindow", "<tab>", None)
        )

        self.SeparatorcomboBox.setCurrentText(
            QCoreApplication.translate("ImportOptionsWindow", "<space>", None)
        )
        self.PreviewButton.setText(
            QCoreApplication.translate("ImportOptionsWindow", "Preview", None)
        )
