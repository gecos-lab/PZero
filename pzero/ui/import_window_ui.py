...
################################################################################
## Form generated from reading UI file 'import_windowuvIRAj.ui'
##
...
class Ui_ImportOptionsWindow(object):
    def setupUi(self, ImportOptionsWindow):
        ...
        self.dataPreviewLabel.setAlignment(Qt.AlignCenter)
        ...
        self.dataAssignLabel.setFrameShape(QFrame.NoFrame)
        self.dataAssignLabel.setFrameShadow(QFrame.Plain)
        self.dataAssignLabel.setAlignment(Qt.AlignCenter)
        ...
        self.OptionsFrame.setFrameShape(QFrame.Box)
        ...
        self.OptionsLayout.addWidget(self.OptionsLabel, 0, Qt.AlignHCenter)
        ...
        self.ConfirmBox.setOrientation(Qt.Horizontal)
        self.ConfirmBox.setStandardButtons(QDialogButtonBox.Close|QDialogButtonBox.Ok)
        self.ConfirmBox.setCenterButtons(True)

        self.horizontalLayout_4.addWidget(self.ConfirmBox)


        self.OptionsLayout.addWidget(self.gridWidget, 0, Qt.AlignHCenter)
