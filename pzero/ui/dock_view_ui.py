...
from PySide6.QtWidgets import (QAbstractItemView, QApplication, QFrame, QHBoxLayout,
    QHeaderView, QLayout, QSizePolicy, QSplitter,
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.GeologyTreePage_2.setObjectName(u"GeologyTreePage_2")
        ...
        self.GeologyTreeWidget_2.setObjectName(u"GeologyTreeWidget_2")
        sizePolicy.setHeightForWidth(self.GeologyTreeWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.GeologyTreePage_2, u"Geology > Geology Tree")
        self.TopologyTreePage_2 = QWidget()
        self.TopologyTreePage_2.setObjectName(u"TopologyTreePage_2")
        ...
        self.TopologyTreeWidget_2.setObjectName(u"TopologyTreeWidget_2")
        sizePolicy.setHeightForWidth(self.TopologyTreeWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.TopologyTreePage_2, u"Geology > Topology Tree")
        self.XSectionListPage_2 = QWidget()
        self.XSectionListPage_2.setObjectName(u"XSectionListPage_2")
        ...
        self.XSectionTreeWidget_2.setObjectName(u"XSectionTreeWidget_2")
        sizePolicy.setHeightForWidth(self.XSectionTreeWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.XSectionTreeWidget_2.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
        self.XSectionTreeWidget_2.setHorizontalScrollMode(QAbstractItemView.ScrollMode.ScrollPerItem)
        self.XSectionTreeWidget_2.setAutoExpandDelay(-1)

        self.verticalLayout_16.addWidget(self.XSectionTreeWidget_2)

        self.toolBox_2.addItem(self.XSectionListPage_2, u"X Section")
        self.BoundariesPage_2 = QWidget()
        self.BoundariesPage_2.setObjectName(u"BoundariesPage_2")
        self.BoundariesPage_2.setGeometry(QRect(0, 0, 98, 74))
        sizePolicy1.setHeightForWidth(self.BoundariesPage_2.sizePolicy().hasHeightForWidth())
        ...
        self.BoundariesTableWidget_2.setObjectName(u"BoundariesTableWidget_2")
        sizePolicy.setHeightForWidth(self.BoundariesTableWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.BoundariesPage_2, u"Boundaries")
        self.Mesh3DPage_2 = QWidget()
        self.Mesh3DPage_2.setObjectName(u"Mesh3DPage_2")
        ...
        self.Mesh3DTableWidget_2.setObjectName(u"Mesh3DTableWidget_2")
        sizePolicy.setHeightForWidth(self.Mesh3DTableWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.Mesh3DPage_2, u"3D Meshes and Grids")
        self.DOMsPage_2 = QWidget()
        self.DOMsPage_2.setObjectName(u"DOMsPage_2")
        ...
        self.DOMsTableWidget_2.setObjectName(u"DOMsTableWidget_2")
        sizePolicy.setHeightForWidth(self.DOMsTableWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.DOMsPage_2, u"DEMs and DOMs")
        self.WellsPage_2 = QWidget()
        self.WellsPage_2.setObjectName(u"WellsPage_2")
        ...
        self.WellsTreeWidget_2.setObjectName(u"WellsTreeWidget_2")

        self.verticalLayout_20.addWidget(self.WellsTreeWidget_2)

        self.toolBox_2.addItem(self.WellsPage_2, u"Wells")
        self.FluidsTreePage_2 = QWidget()
        self.FluidsTreePage_2.setObjectName(u"FluidsTreePage_2")
        ...
        self.FluidsTreeWidget_2.setObjectName(u"FluidsTreeWidget_2")

        self.verticalLayout_21.addWidget(self.FluidsTreeWidget_2)

        self.toolBox_2.addItem(self.FluidsTreePage_2, u"Fluids > Fluids Tree")
        self.FluidsTopologyTree_2 = QWidget()
        self.FluidsTopologyTree_2.setObjectName(u"FluidsTopologyTree_2")
        ...
        self.FluidsTopologyTreeWidget_2.setObjectName(u"FluidsTopologyTreeWidget_2")

        self.verticalLayout_22.addWidget(self.FluidsTopologyTreeWidget_2)

        self.toolBox_2.addItem(self.FluidsTopologyTree_2, u"Fluids > Topology Tree")
        self.BackgroundsTreePage_2 = QWidget()
        self.BackgroundsTreePage_2.setObjectName(u"BackgroundsTreePage_2")
        ...
        self.BackgroundsTreeWidget_2.setObjectName(u"BackgroundsTreeWidget_2")

        self.verticalLayout_23.addWidget(self.BackgroundsTreeWidget_2)

        self.toolBox_2.addItem(self.BackgroundsTreePage_2, u"Background data > Backgrounds tree")
        self.BackgroundsTopologyTree_2 = QWidget()
        self.BackgroundsTopologyTree_2.setObjectName(u"BackgroundsTopologyTree_2")
        ...
        self.BackgroundsTopologyTreeWidget_2 = QTreeWidget(self.BackgroundsTopologyTree_2)
        ...
        self.BackgroundsTopologyTreeWidget_2.setObjectName(u"BackgroundsTopologyTreeWidget_2")

        self.verticalLayout_24.addWidget(self.BackgroundsTopologyTreeWidget_2)

        self.toolBox_2.addItem(self.BackgroundsTopologyTree_2, u"Background data > Topology tree")
        self.ImagesPage_2 = QWidget()
        self.ImagesPage_2.setObjectName(u"ImagesPage_2")
        ...
        self.ImagesTableWidget_2.setObjectName(u"ImagesTableWidget_2")
        sizePolicy.setHeightForWidth(self.ImagesTableWidget_2.sizePolicy().hasHeightForWidth())
        ...
        self.toolBox_2.addItem(self.ImagesPage_2, u"Images")
        self.splitter.addWidget(self.toolBox_2)
        self.ViewFrame_2 = QFrame(self.splitter)
        self.ViewFrame_2.setObjectName(u"ViewFrame_2")
        ...
        self.ViewFrameLayout_2.setObjectName(u"ViewFrameLayout_2")
        self.ViewFrameLayout_2.setSizeConstraint(QLayout.SizeConstraint.SetDefaultConstraint)
    ...
    def retranslateUi(self, Form):
        ...
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.GeologyTreePage_2), QCoreApplication.translate("Form", u"Geology > Geology Tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.TopologyTreePage_2), QCoreApplication.translate("Form", u"Geology > Topology Tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.XSectionListPage_2), QCoreApplication.translate("Form", u"X Section", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.BoundariesPage_2), QCoreApplication.translate("Form", u"Boundaries", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.Mesh3DPage_2), QCoreApplication.translate("Form", u"3D Meshes and Grids", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.DOMsPage_2), QCoreApplication.translate("Form", u"DEMs and DOMs", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.WellsPage_2), QCoreApplication.translate("Form", u"Wells", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.FluidsTreePage_2), QCoreApplication.translate("Form", u"Fluids > Fluids Tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.FluidsTopologyTree_2), QCoreApplication.translate("Form", u"Fluids > Topology Tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.BackgroundsTreePage_2), QCoreApplication.translate("Form", u"Background data > Backgrounds tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.BackgroundsTopologyTree_2), QCoreApplication.translate("Form", u"Background data > Topology tree", None))
        self.toolBox_2.setItemText(self.toolBox_2.indexOf(self.ImagesPage_2), QCoreApplication.translate("Form", u"Images", None))
    # retranslateUi
