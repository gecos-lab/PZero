...
class Ui_Base_View(object):
    def setupUi(self, Base_View):
        Base_View.setObjectName("Base_View")
        Base_View.resize(940, 662)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(Base_View)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.ToolButtonsFrame = QtWidgets.QFrame(Base_View)
        ...
        self.splitter = QtWidgets.QSplitter(Base_View)
        ...
        self.GeologyTreePage.setGeometry(QtCore.QRect(0, 0, 274, 308))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        ...
        self.TopologyTreePage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.XSectionListPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.BoundariesPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.Mesh3DPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.DOMsPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.WellsPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        ...
        self.FluidsTreePage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        ...
        self.FluidsTopologyTree.setGeometry(QtCore.QRect(0, 0, 98, 89))
        ...
        self.BackgroundsTreePage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        ...
        self.BackgroundsTopologyTree.setGeometry(QtCore.QRect(0, 0, 98, 89))
        ...
        self.ImagesPage.setGeometry(QtCore.QRect(0, 0, 98, 89))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        ...
        self.retranslateUi(Base_View)
        self.toolBox.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(Base_View)

    def retranslateUi(self, Base_View):
        _translate = QtCore.QCoreApplication.translate
        Base_View.setWindowTitle(_translate("Base_View", "Form"))
        self.SaveHomeButton.setToolTip(_translate("Base_View", "Save home view"))
        self.SaveHomeButton.setText(_translate("Base_View", "SH"))
        self.ZoomHomeButton.setToolTip(_translate("Base_View", "Zoom to home view"))
        self.ZoomHomeButton.setText(_translate("Base_View", "ZH"))
        self.ZoomActiveButton.setToolTip(_translate("Base_View", "Zoom to home view"))
        self.ZoomActiveButton.setText(_translate("Base_View", "ZA"))
        self.SelectEntityButton.setToolTip(_translate("Base_View", "Zoom to home view"))
        self.SelectEntityButton.setText(_translate("Base_View", "SE"))
        self.ClearSelectionButton.setToolTip(_translate("Base_View", "Zoom to home view"))
        self.ClearSelectionButton.setText(_translate("Base_View", "CS"))
        self.RemoveEntityButton.setToolTip(_translate("Base_View", "Zoom to home view"))
        self.RemoveEntityButton.setText(_translate("Base_View", "RE"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.GeologyTreePage), _translate("Base_View", "Geology > Geology Tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.TopologyTreePage), _translate("Base_View", "Geology > Topology Tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.XSectionListPage), _translate("Base_View", "X Section"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.BoundariesPage), _translate("Base_View", "Boundaries"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.Mesh3DPage), _translate("Base_View", "3D Meshes and Grids"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.DOMsPage), _translate("Base_View", "DEMs and DOMs"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.WellsPage), _translate("Base_View", "Wells"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.FluidsTreePage), _translate("Base_View", "Fluids > Fluids Tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.FluidsTopologyTree), _translate("Base_View", "Fluids > Topology Tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.BackgroundsTreePage), _translate("Base_View", "Background data > Backgrounds tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.BackgroundsTopologyTree), _translate("Base_View", "Background data > Topology tree"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.ImagesPage), _translate("Base_View", "Images"))
