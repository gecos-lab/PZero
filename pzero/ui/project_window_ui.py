...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        self.actionConvert2XSection = QtWidgets.QAction(ProjectWindow)
        self.actionConvert2XSection.setObjectName("actionConvert2XSection")
        ...
        self.menuInterpolation_tools.addAction(self.actionConvert2XSection)
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.actionConvert2XSection.setText(_translate("ProjectWindow", "Convert to XSection"))
