...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        self.menuPoint_Clouds = QMenu(self.menubar)
        self.menuPoint_Clouds.setObjectName(u"menuPoint_Clouds")
        ...
        self.menubar.addAction(self.menuPoint_Clouds.menuAction())
        ...
        self.menuEdit.addAction(self.actionCloneEntity)
        self.menuEdit.addAction(self.actionRemoveEntity)
        ...
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionCalculateNormals)
        self.menuEdit.addAction(self.actionCalculateLineations)
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionAddTexture)
        self.menuEdit.addAction(self.actionRemoveTexture)
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionShowInfoOnEntities)
        ...
        self.menuPoint_Clouds.addAction(self.actionBuildOctree)
        self.menuPoint_Clouds.addAction(self.actionDecimatePointCloud)
        self.menuSurfaces.addAction(self.actionSplitSurfaces)
        self.menuProject.addAction(self.actionProject2XSection)
        self.menuProject.addAction(self.actionXSectionIntersection)
        self.menuProject.addAction(self.actionProject2DEM)
        self.menuProject.addAction(self.actionExtrusion)
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.menuPoint_Clouds.setTitle(QCoreApplication.translate("ProjectWindow", u"Point Clouds", None))
        ...
        self.menuProject.setTitle(QCoreApplication.translate("ProjectWindow", u"Projection", None))
    # retranslateUi
