...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        ProjectWindow.setMinimumSize(QtCore.QSize(0, 0))
        ProjectWindow.setBaseSize(QtCore.QSize(1280, 800))
        ...
        self.centralwidget.setBaseSize(QtCore.QSize(638, 757))
        ...
        self.tabCentral.setMinimumSize(QtCore.QSize(0, 0))
        self.tabCentral.setBaseSize(QtCore.QSize(0, 0))
        ...
        self.tabGeology.setMinimumSize(QtCore.QSize(0, 0))
        self.tabGeology.setBaseSize(QtCore.QSize(0, 0))
        self.tabGeology.setObjectName("tabGeology")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.tabGeology)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabXSections.sizePolicy().hasHeightForWidth())
        self.tabXSections.setSizePolicy(sizePolicy)
        self.tabXSections.setObjectName("tabXSections")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.tabXSections)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.XSectionsTableView = QtWidgets.QTableView(self.tabXSections)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.XSectionsTableView.sizePolicy().hasHeightForWidth())
        self.XSectionsTableView.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabBoundaries.sizePolicy().hasHeightForWidth())
        self.tabBoundaries.setSizePolicy(sizePolicy)
        self.tabBoundaries.setObjectName("tabBoundaries")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.tabBoundaries)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.BoundariesTableView = QtWidgets.QTableView(self.tabBoundaries)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.BoundariesTableView.sizePolicy().hasHeightForWidth())
        self.BoundariesTableView.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabMeshes3D.sizePolicy().hasHeightForWidth())
        self.tabMeshes3D.setSizePolicy(sizePolicy)
        self.tabMeshes3D.setObjectName("tabMeshes3D")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.tabMeshes3D)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.Meshes3DTableView = QtWidgets.QTableView(self.tabMeshes3D)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.Meshes3DTableView.sizePolicy().hasHeightForWidth())
        self.Meshes3DTableView.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabDOMs.sizePolicy().hasHeightForWidth())
        self.tabDOMs.setSizePolicy(sizePolicy)
        self.tabDOMs.setObjectName("tabDOMs")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.tabDOMs)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.DOMsTableView = QtWidgets.QTableView(self.tabDOMs)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.DOMsTableView.sizePolicy().hasHeightForWidth())
        self.DOMsTableView.setSizePolicy(sizePolicy)
        ...
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.tabImages)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.ImagesTableView = QtWidgets.QTableView(self.tabImages)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.ImagesTableView.sizePolicy().hasHeightForWidth())
        self.ImagesTableView.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabWells.sizePolicy().hasHeightForWidth())
        self.tabWells.setSizePolicy(sizePolicy)
        self.tabWells.setObjectName("tabWells")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout(self.tabWells)
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.WellsTableView = QtWidgets.QTableView(self.tabWells)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.WellsTableView.sizePolicy().hasHeightForWidth())
        self.WellsTableView.setSizePolicy(sizePolicy)
        self.WellsTableView.setMinimumSize(QtCore.QSize(0, 0))
        ...
        sizePolicy.setHeightForWidth(self.tabFluids.sizePolicy().hasHeightForWidth())
        self.tabFluids.setSizePolicy(sizePolicy)
        self.tabFluids.setMinimumSize(QtCore.QSize(1, 1))
        self.tabFluids.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.tabFluids.setObjectName("tabFluids")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.tabFluids)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.FluidsTableView = QtWidgets.QTableView(self.tabFluids)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.FluidsTableView.sizePolicy().hasHeightForWidth())
        self.FluidsTableView.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tabBackgrounds.sizePolicy().hasHeightForWidth())
        self.tabBackgrounds.setSizePolicy(sizePolicy)
        self.tabBackgrounds.setObjectName("tabBackgrounds")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.tabBackgrounds)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.BackgroundsTableView = QtWidgets.QTableView(self.tabBackgrounds)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.BackgroundsTableView.sizePolicy().hasHeightForWidth())
        self.BackgroundsTableView.setSizePolicy(sizePolicy)
        ...
        self.tabLegend.setMinimumSize(QtCore.QSize(0, 0))
        self.tabLegend.setBaseSize(QtCore.QSize(0, 0))
        self.tabLegend.setObjectName("tabLegend")
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.tabLegend)
        ...
        self.tabProperties.setMinimumSize(QtCore.QSize(0, 0))
        self.tabProperties.setBaseSize(QtCore.QSize(0, 0))
        self.tabProperties.setToolTipDuration(-3)
        self.tabProperties.setObjectName("tabProperties")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.tabProperties)
        ...
        self.tabTerminal.setMinimumSize(QtCore.QSize(0, 0))
        self.tabTerminal.setBaseSize(QtCore.QSize(0, 0))
        self.tabTerminal.setObjectName("tabTerminal")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout(self.tabTerminal)
        ...
        self.actionShowInfo = QtWidgets.QAction(ProjectWindow)
        ...
        self.menuEdit.addSeparator()
        self.menuEdit.addAction(self.actionShowInfo)
        ...
        self.menuPoint_cloud.addAction(self.actionBuildOctree)
        self.menuPoint_cloud.addAction(self.actionDecimatePointCloud)
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.menuPoint_cloud.setTitle(_translate("ProjectWindow", "Point Clouds"))
        ...
        self.actionCalculateNormal.setText(_translate("ProjectWindow", "Calculate Normals"))
        self.actionCalculateNormal.setToolTip(_translate("ProjectWindow", "Calculate normal unit vector"))
        self.actionCalculateLineation.setText(_translate("ProjectWindow", "Calculate Lineations"))
        ...
        self.actionShowInfo.setText(_translate("ProjectWindow", "Show Entities Info"))
