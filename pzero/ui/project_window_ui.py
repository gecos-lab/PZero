...
################################################################################
## Form generated from reading UI file 'project_windowOYprOZ.ui'
##
...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        self.menuPoint_Clouds.addAction(self.actionSurface_Density)
        self.menuPoint_Clouds.addAction(self.actionRoughness)
        self.menuPoint_Clouds.addAction(self.actionCurvature)
        self.menuPoint_Clouds.addAction(self.actionThreshold)
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.menuEdit.setTitle(QCoreApplication.translate("ProjectWindow", u"Entities", None))
