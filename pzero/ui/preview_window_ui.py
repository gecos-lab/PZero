...
################################################################################
## Form generated from reading UI file 'preview_windowTjGwLa.ui'
##
...
class Ui_PreviewWindow(object):
    def setupUi(self, PreviewWindow):
        ...
        self.ConfirmButtonBox.setStandardButtons(QDialogButtonBox.StandardButton.Cancel|QDialogButtonBox.StandardButton.Ok)
        self.ConfirmButtonBox.setCenterButtons(False)

        self.verticalLayout.addWidget(self.ConfirmButtonBox)


        self.horizontalLayout_2.addWidget(self.OptionsWidget, 0, Qt.AlignmentFlag.Qt.AlignmentFlag.AlignVCenter)
