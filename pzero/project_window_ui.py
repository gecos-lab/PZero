...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        self.tabFritti = QtWidgets.QWidget()
        self.tabFritti.setObjectName("tabFritti")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.tabFritti)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.FrittiTableView = QtWidgets.QTableView(self.tabFritti)
        self.FrittiTableView.setObjectName("FrittiTableView")
        self.verticalLayout_11.addWidget(self.FrittiTableView)
        self.tabCentral.addTab(self.tabFritti, "")
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.tabCentral.setTabText(self.tabCentral.indexOf(self.tabFritti), _translate("ProjectWindow", "Fritti misti"))
