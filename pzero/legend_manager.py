...
class Legend(QObject):
    ...
    def update_widget(self, parent=None):
        ...
        parent.LegendTreeWidget.setHeaderLabels(['Type > Feature > Scenario', 'R', 'G', 'B', 'Color', 'Line thickness',
                                                 'Point size', 'Opacity', 'Geological Time', 'Stratigraphic sequence',
                                                 'Show edges', 'Show nodes'])
        parent.LegendTreeWidget.setItemsExpandable(True)
        for other_type in pd_unique(parent.others_legend_df['other_type']):
            color_R = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "color_R"].values[0]
            color_G = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "color_G"].values[0]
            color_B = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "color_B"].values[0]
            line_thick = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "line_thick"].values[0]
            point_size = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "point_size"].values[0]
            opacity = \
            parent.others_legend_df.loc[parent.others_legend_df['other_type'] == other_type, "opacity"].values[0]
            ...
            "Create items"
            llevel_1 = QTreeWidgetItem(parent.LegendTreeWidget, [other_type, str(color_R), str(color_G),
        ...
        for geo_type in pd_unique(parent.geol_legend_df['geological_type']):
            llevel_1 = QTreeWidgetItem(parent.LegendTreeWidget,
                                       [geo_type])  # self.GeologyTreeWidget as parent -> top level
            for feature in pd_unique(parent.geol_legend_df.loc[
                                         parent.geol_legend_df['geological_type'] == geo_type, 'geological_feature']):
                llevel_2 = QTreeWidgetItem(llevel_1, [feature])  # llevel_1 as parent -> 2nd level
                for scenario in pd_unique(parent.geol_legend_df.loc[
                                              (parent.geol_legend_df['geological_type'] == geo_type) & (
                                                      parent.geol_legend_df[
                                                          'geological_feature'] == feature), 'scenario']):
                    color_R = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                                parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                               'scenario'] == scenario), "color_R"].values[
                        0]
                    color_G = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                                parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                               'scenario'] == scenario), "color_G"].values[
                        0]
                    color_B = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                                parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                               'scenario'] == scenario), "color_B"].values[
                        0]
                    ...
                    geol_time_value = parent.geol_legend_df.loc[
                        (parent.geol_legend_df['geological_type'] == geo_type) & (
                                    ...
                                    parent.geol_legend_df['scenario'] == scenario), "geological_time"].values[0]
                    ...
                    geol_sequence_value = parent.geol_legend_df.loc[
                        (parent.geol_legend_df['geological_type'] == geo_type) & (
                                    parent.geol_legend_df['geological_feature'] == feature) & (
                                    parent.geol_legend_df['scenario'] == scenario), "geological_sequence"].values[0]
                    ...
                    "Create items"
                    llevel_3 = QTreeWidgetItem(llevel_2, [scenario, str(color_R), str(color_G),
                    ...
                    parent.LegendTreeWidget.setItemWidget(llevel_3, 9, geol_sequence_combo)
                    "Set signals for the widgets below"
        ...
        for locid in pd_unique(parent.well_legend_df['Loc ID']):
            llevel_1 = QTreeWidgetItem(parent.LegendTreeWidget,
                                       ['Wells'])  # self.GeologyTreeWidget as parent -> top level
            ...
            well_line_opacity_spn.valueChanged.connect(lambda: self.change_well_line_opacity(parent=parent))
        for fluid_type in pd_unique(parent.fluids_legend_df['fluid_type']):
            llevel_1 = QTreeWidgetItem(parent.LegendTreeWidget,
                                       [fluid_type])  # self.GeologyTreeWidget as parent -> top level
            for feature in pd_unique(
                    parent.fluids_legend_df.loc[parent.fluids_legend_df['fluid_type'] == fluid_type, 'fluid_feature']):
                llevel_2 = QTreeWidgetItem(llevel_1, [feature])  # llevel_1 as parent -> 2nd level
                for scenario in pd_unique(parent.fluids_legend_df.loc[
                                              (parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                                      parent.fluids_legend_df[
                                                          'fluid_feature'] == feature), 'scenario']):
                    color_R = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                            'scenario'] == scenario), "color_R"].values[
                        0]
                    color_G = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                            'scenario'] == scenario), "color_G"].values[
                        0]
                    color_B = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                            'scenario'] == scenario), "color_B"].values[
                        0]
                    line_thick = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                            'scenario'] == scenario), "line_thick"].values[
                        0]
                    ...
                    fluid_time_value = parent.fluids_legend_df.loc[
                        (parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                                    ...
                                    parent.fluids_legend_df['scenario'] == scenario), "fluid_time"].values[0]
        ...
        for background_type in pd_unique(parent.backgrounds_legend_df['background_type']):
            llevel_1 = QTreeWidgetItem(parent.LegendTreeWidget,
                                       [background_type])  # self.GeologyTreeWidget as parent -> top level
            for feature in pd_unique(parent.backgrounds_legend_df.loc[parent.backgrounds_legend_df[
                ...
                color_R = parent.backgrounds_legend_df.loc[
                    (parent.backgrounds_legend_df['background_type'] == background_type) & (
                                parent.backgrounds_legend_df['background_feature'] == feature), "color_R"].values[0]
                color_G = parent.backgrounds_legend_df.loc[
                    (parent.backgrounds_legend_df['background_type'] == background_type) & (
                                parent.backgrounds_legend_df['background_feature'] == feature), "color_G"].values[0]
                color_B = parent.backgrounds_legend_df.loc[
                    (parent.backgrounds_legend_df['background_type'] == background_type) & (
                                parent.backgrounds_legend_df['background_feature'] == feature), "color_B"].values[0]
    ...
    def change_geology_feature_color(self, parent=None):
        ...
        old_color_R = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                   'scenario'] == scenario), "color_R"].values[
            0]
        old_color_G = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                   'scenario'] == scenario), "color_G"].values[
            0]
        old_color_B = parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                   'scenario'] == scenario), "color_B"].values[
            0]
        color_in = QColor(old_color_R, old_color_G,
                          old_color_B)  # https://doc.qt.io/qtforpython/PySide2/QtGui/QColor.html#PySide2.QtGui.QColor
        color_out = QColorDialog.getColor(initial=color_in,
                                          title="Select color")  # https://doc.qt.io/qtforpython/PySide2/QtWidgets/QColorDialog.html#PySide2.QtWidgets.PySide2.QtWidgets.QColorDialog.getColor
        ...
        parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (
                                              parent.geol_legend_df['scenario'] == scenario), "color_R"] = new_color_R
        parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (
                                              parent.geol_legend_df['scenario'] == scenario), "color_G"] = new_color_G
        parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (
                                              parent.geol_legend_df['scenario'] == scenario), "color_B"] = new_color_B
        """Update button color."""
    ...
    def change_geological_time(self, parent=None):
        ...
        parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                   'scenario'] == scenario), "geological_time"] = geol_time
    ...
    def change_geological_sequence(self, parent=None):
        ...
        parent.geol_legend_df.loc[(parent.geol_legend_df['geological_type'] == geo_type) & (
                    parent.geol_legend_df['geological_feature'] == feature) & (parent.geol_legend_df[
                                                                                   'scenario'] == scenario), "geological_sequence"] = geol_seqn
    ...
    def change_fluid_feature_color(self, parent=None):
        ...
        scenario = self.sender().scenario
        """Here we use the same query as above to GET the color from the legend"""
        old_color_R = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_R"].values[
            0]
        old_color_G = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_G"].values[
            0]
        old_color_B = parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_B"].values[
            0]
        color_in = QColor(old_color_R, old_color_G,
        ...
        parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_R"] = new_color_R
        parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_G"] = new_color_G
        parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "color_B"] = new_color_B
        """Update button color."""
        self.sender().setStyleSheet("background-color:rgb({},{},{})".format(new_color_R, new_color_G, new_color_B))
        """Signal to update actors in windows. This is emitted only for the modified uid under the 'color' key."""
    ...
    def change_fluid_time(self, parent=None):
        ...
        parent.fluids_legend_df.loc[(parent.fluids_legend_df['fluid_type'] == fluid_type) & (
                    parent.fluids_legend_df['fluid_feature'] == feature) & (parent.fluids_legend_df[
                                                                                'scenario'] == scenario), "fluid_time"] = fluid_time
        """Order geological legend entities with descending geological_time values"""
    ...
    def change_background_feature_color(self, parent=None):
        ...
        parent.backgrounds_legend_df.loc[(parent.backgrounds_legend_df['background_type'] == background_type) & (
                    parent.backgrounds_legend_df['background_feature'] == feature), "color_R"] = new_color_R
        parent.backgrounds_legend_df.loc[(parent.backgrounds_legend_df['background_type'] == background_type) & (
                    parent.backgrounds_legend_df['background_feature'] == feature), "color_G"] = new_color_G
        parent.backgrounds_legend_df.loc[(parent.backgrounds_legend_df['background_type'] == background_type) & (
                    parent.backgrounds_legend_df['background_feature'] == feature), "color_B"] = new_color_B
        """Update button color."""
        self.sender().setStyleSheet("background-color:rgb({},{},{})".format(new_color_R, new_color_G, new_color_B))
        """Signal to update actors in windows. This is emitted only for the modified uid under the 'color' key."""
