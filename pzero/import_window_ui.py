...
class Ui_ImportOptionsWindow(object):
    def setupUi(self, ImportOptionsWindow):
        ...
        self.RefreshtoolButton = QtWidgets.QToolButton(self.ImportGroupBox)
        self.RefreshtoolButton.setObjectName("RefreshtoolButton")
        self.horizontalLayout_3.addWidget(self.RefreshtoolButton)
    ...
    def retranslateUi(self, ImportOptionsWindow):
        ...
        self.RefreshtoolButton.setText(_translate("ImportOptionsWindow", "⟳"))
