...
class GeologicalCollection(QAbstractTableModel):
    ...
    def __init__(self, parent=None, *args, **kwargs):
        ...
        self.editable_columns = self.df.columns.get_indexer(
            ["name", "geological_type", "geological_feature", "scenario"]
        )
    ...
    def get_geological_type_uids(self, geological_type=None):
        ...
        return self.df.loc[
            self.df["geological_type"] == geological_type, "uid"
        ].to_list()
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        if index.isValid():
            ...
            if self.data(index, Qt.DisplayRole) == value:
                ...
                self.parent.geology_metadata_modified_signal.emit(
                    [uid]
                )  # a list of uids is emitted, even if the entity is just one
                return True
        return QVariant()
