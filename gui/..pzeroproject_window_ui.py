...
class Ui_ProjectWindow(object):
    def setupUi(self, ProjectWindow):
        ...
        self.actionImport_well_data = QtWidgets.QAction(ProjectWindow)
        self.actionImport_well_data.setObjectName("actionImport_well_data")
        ...
        self.menuFile.addAction(self.actionImport_well_data)
        ...
        self.toolbarFile.addAction(self.actionImport_well_data)
    ...
    def retranslateUi(self, ProjectWindow):
        ...
        self.actionImport_well_data.setText(_translate("ProjectWindow", "Import well data"))
